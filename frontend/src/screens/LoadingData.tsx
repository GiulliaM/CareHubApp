...
export default function LoadingData({ navigation }: any) {
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]}>
      <View style={styles.content}>
        ...
        <View style={styles.heartContainer}>
          ...
          <Ionicons name="heart-outline" size={200} color={colors.primary} style={styles.heartOutline} />
          
          {/* Container para o preenchimento */}
          <View style={styles.fillContainer}>
            <Animated.View style={[styles.fillHeart, { height: fillHeight }]}>
              <Ionicons name="heart" size={200} color={colors.primary} />
            </Animated.View>
          </View>
        </View>
